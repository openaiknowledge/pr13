//  ReasoningReactiveProcessDefault.swift
//  Brain
//
//  Created by Miguel Gutierrez on 21/05/2022
//
//  Default implementation of ReasoningReactive processes
//
import Foundation

// MARK: - ReasoningReactiveProcessDefault
class ReasoningReactiveProcessDefault {
...
extension ReasoningReactiveProcessDefault {
    static func build(with activities: [Activity], nextProcess: [Process]) -> ReasoningReactiveProcessDefault {
        let processModel = ReasoningReactiveProcessModelDefault()

        return ReasoningReactiveProcessDefault(model: processModel, activities: activities, nextProcess: nextProcess)
    }
}
// MARK: public access
extension ReasoningReactiveProcessDefault {
...
extension ReasoningReactiveProcessDefault: ReasoningReactiveProcess {
...
struct ReasoningReactiveProcessModelDefault: ProcessModel {
